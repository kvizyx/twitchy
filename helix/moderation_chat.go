...
func (s *ModerationService) DeleteChatMessages(ctx context.Context, req DeleteChatMessagesRequest) (*Response[DeleteChatMessagesData], error) {
	return executeModerationEndpoint[DeleteChatMessagesData](moderationEndpointSpec{client: s.client, ctx: ctx, anchor: "delete-chat-messages", query: req, auth: moderationAuthorization{userScopeSets: chatReadScopes(ScopeModeratorManageChatMessages), subjectIDs: []string{req.ModeratorID}}})
}
